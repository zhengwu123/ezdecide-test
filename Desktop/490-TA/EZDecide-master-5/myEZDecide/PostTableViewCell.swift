    ...
    var post: Post! {
        didSet {
            ...
            if let optionOneImageUrl = post.optionOneImageUrl {
                ...
                // topLeftImageView.af_setImage(withURL: optionOneImageUrl, placeholderImage: UIImage(named: "home"))
            ...
            if let optionTwoImageUrl = post.optionTwoImageUrl {
                ...
                /*
                if let optionTwoImage = imageCache.image(withIdentifier: optionTwoImageUrl.absoluteString) {
                    topRightImageView.image = optionTwoImage
                } else {
                    topRightImageView.af_setImage(withURL: optionTwoImageUrl, placeholderImage: UIImage(named: "home"))
                    imageCache.add
                }
                */
            ...
            if let optionThreeImageUrl = post.optionThreeImageUrl {
                ...
                if let optionFourImageUrl = post.optionFourImageUrl {
                    ...
                    // bottomLeftImageView.af_setImage(withURL: optionThreeImageUrl, placeholderImage: UIImage(named: "home"))
                    ...
                    // bottomRightImageView.af_setImage(withURL: optionFourImageUrl, placeholderImage: UIImage(named: "home"))
                    ...
                    // bottomRightImageView.af_setImage(withURL: optionThreeImageUrl, placeholderImage: UIImage(named: "home"))
